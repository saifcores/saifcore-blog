...
- [Le callback qui a dit `SUCCESS`](/fr/articles/when-success-is-not-settled) — vendredi Payé. Lundi, la ligne avait disparu.
...
La suite, c'est ce qui arrive quand vous shipez les trois états et copiez encore le mot du provider : [Le callback qui a dit `SUCCESS`](/fr/articles/when-success-is-not-settled).
