...
excerpt: "Scaler n'est pas un plus gros cluster Postgres. C'est des frontières d'argent claires, des commandes idempotentes, et un ledger que la finance peut défendre sous pression."
kind: code
publishedAt: "2025-01-22"
cover: "/images/articles/scalable-fintech-systems.png"
tags: [fintech, idempotence, paiements, ledger, architecture]
