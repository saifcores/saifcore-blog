...
Le callback a menti avec un mot. Celui-ci ment avec le silence.
...
Même règle que dans [systèmes fintech à l'échelle](/fr/articles/scalable-fintech-systems) et [le callback qui a dit SUCCESS](/fr/articles/when-success-is-not-settled) : les retries sont inévitables ; une réponse réseau ambiguë n'autorise pas un second débit.
