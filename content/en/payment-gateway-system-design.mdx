...
The vocabulary and failure modes map cleanly onto the same boundaries we use for mobile money in [scalable fintech systems](/articles/scalable-fintech-systems) and [when SUCCESS is not settled](/articles/when-success-is-not-settled).
