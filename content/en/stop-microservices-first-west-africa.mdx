...
excerpt: >-
  Twelve services and three Kafka topics don't fix a two-person ops team. A case
  for a well-modularized monolith until traffic and headcount actually justify
  the split.
kind: writing
